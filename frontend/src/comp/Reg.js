  ...
  return (
    <div className='formcon'>
        <div className='form'>
            ...
            <input type='text' placeholder='Enter Phono Number' name="phno" value={user.phno} onChange={fun}/>
            ...
            <div className='radio'>
                Gender: <input type='radio' value="male" onChange={fun} name='gen' checked={user.gen=="male"}/>Male<input type='radio' value="female" onChange={fun} name='gen' checked={user.gen=="female"}/>Female
            </div>
